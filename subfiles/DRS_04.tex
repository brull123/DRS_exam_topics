...
\begin{itemize}
	...
	\item The Frobenius form has only one irreducible diagonal block = the entire matrix
	\item There exists a spanning tree of the graph
	\item In case of a spanning forest, the multiplicity of the Laplacian's zero is the minimum number of trees which together span all vertices in the graph
\end{itemize}
