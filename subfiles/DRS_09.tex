...
\begin{align}
	...
	r(v,u) & = c(v,u) + f(u,v),
\end{align}
where the residual capacity says how much more flow can be pushed through the edge.
The backward flow gives a capacity to undo some flow, which may lead to increase in overall flow.
