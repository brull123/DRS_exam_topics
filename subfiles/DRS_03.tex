...
\begin{theorem}{Max flow min cut}{}
	Maximal flow equals the cardinality of the minimum edge cut set times the maximal throughput of each edge.\\
...
One of the applications of the Laplacian matrix is description of diffusions.
The Fourier	equation is
\begin{align}
	\pdv{u(x,t)}{t} & = c \Delta u(x,t).
\end{align}

We can sample in discrete places and then the Fourier equation becomes
\begin{align}
	\odv{u_i}{t} & = c \sum_j A_{ij} (u_j - u_i),
\end{align}
