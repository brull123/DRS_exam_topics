...
The assortative coefficient for scalar characteristics is defined as the true covariance over the covariance in the perfect case, where $x_i = x_k$
\begin{align}
...
\begin{align}
	r & = \frac{\sum_{ij} \left(A_{ij} - \frac{d_i d_j}{2m}\right) d_i d_j}{\sum_{ij} \left(\delta_{ij} d_i - \frac{d_i d_j}{2m}\right) d_i d_j}
\end{align}
